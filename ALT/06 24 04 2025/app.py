...
def get_planetary_info(size):
    return planetary_data.get(size)
...
def index():
    ...
    return render_template("index.html", text=text, value=value, size=size, multiplier=multiplier, table=table, waffaq_info=waffaq_info, planet_info=planet_info)
